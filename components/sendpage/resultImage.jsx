              ...
              return (
                <div
                  ...
                  className={`absolute transform -translate-x-1/2 -translate-y-1/2 ${
                    isSelected
                      ? "border-2 border-dashed border-blue-500 rounded p-1 z-10"
                      : "z-5"
                  }`}
                  style={{
                    left: `${decoration.x}%`,
                    ...
                    cursor:
                      isDragging && draggedDecoration === decoration.id
                        ? "grabbing"
                        : "grab",
                  }}
                  onMouseDown={(e) =>
                    handleDecorationMouseDown(e, decoration.id)
                  }
                >
                  <img
                    src={decoration.url}
                  ...
                  {isSelected && (
                    <div className="resize-handle absolute -right-3 -bottom-3 w-6 h-6 bg-blue-500 rounded-full cursor-nwse-resize border-2 border-white z-20 hover:scale-110 transition-transform" />
                  )}
                  ...
                  {isSelected && (
                    <button
                      className="absolute -right-3 -top-3 w-6 h-6 rounded-full
                                            ...
                                            text-white flex items-center justify-center  z-20 hover:scale-110 transition-transform"
                      onClick={(e) => {
                        e.stopPropagation()
